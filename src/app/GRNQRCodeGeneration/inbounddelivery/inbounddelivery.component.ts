        ...
        next: (tables) => {
          ...
          const payload = {
            DETAIL: {
              ...
              INVOICE: this.tableForm.value.invoiceDate?moment(this.tableForm.value.invoiceDate) :"",//'DefaultInvoice',
              DC_DATE: this.tableForm.value.DocumentDate?moment(this.tableForm.value.DocumentDate) :"", //'2024-11-29',
              ...
              LR_DATE: this.tableForm.value.gateEntryDate?moment(this.tableForm.value.gateEntryDate) :"", //,
